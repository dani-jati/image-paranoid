...
for filename in sorted(os.listdir(source_folder)):
    ...
    line_y = min(h - 1, mid_y + PHILTRUM_OFFSET_Y)

    # === Draw both lines ===
    cv2.line(image, (0, gy), (w, gy), (0, 0, 255), 2)       # Red glabella line
    #cv2.circle(image, (gx, gy), 5, (0, 255, 0), -1)          # Green glabella point
    cv2.line(image, (0, line_y), (w, line_y), (0, 255, 255), 2)  # Cyan phyltrum line

    print(f"✅ {filename}: Glabella ({gx}, {gy}), Phyltrum line y={line_y}")
