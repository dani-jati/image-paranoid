...
for filename in image_files:
    ...
    # === Resize image to half screen height and move to top ===
    screen_width = 1280
    screen_height = 720
    ...
    points = []  # ✅ Declare before using

    # Prepare window and force it to top-left corner
    ...
    subprocess.run(["xdotool", "search", "--name", "Click Shoulder Points", "windowmove", "0", "0"])
    ...
    cv2.setMouseCallback("Click Shoulder Points", click_event)  # ✅ No need to re-create window
    cv2.imshow("Click Shoulder Points", clone)
    ...
    if len(points) == 2:
        ...
        cv2.waitKey(0)
        cv2.destroyAllWindows()  # ← Add this line to close all windows
