...
interocular_width_input = os.path.join(script_dir, "../images/input_images/interocular_width")
...
"""
output_folders = {
    "wide": os.path.join(script_dir, "../images/output_images/interocular_width/1.65_or_more"),
    "mid": os.path.join(script_dir, "../images/output_images/interocular_width/1.35_to_1.65"),
    "narrow": os.path.join(script_dir, "../images/output_images/interocular_width/0_to_1.35"),
}
"""
