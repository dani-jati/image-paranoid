...
mouth_width_input = os.path.normpath(os.path.join(script_dir, "..", "images", "input_images", "mouth_width"))
path = mouth_width_input

if os.path.isdir(cropper_output) and not os.path.exists(mouth_width_input):

    if os.name == 'posix': #linux or mac
        os.symlink(cropper_output, mouth_width_input) #linux
    elif os.name == 'nt': #windows
        os.symlink(cropper_output, mouth_width_input, target_is_directory=True) #windows
