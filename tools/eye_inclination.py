...
class Dashboard(QMainWindow):
    def __init__(self):
        ...
        # Log
        self.log_file = open(os.path.join(script_dir, "../session_log/eye_inclination.txt"), "a", encoding="utf-8")
        ...
        # State
        self.clicks = []
        self.files = [os.path.join(eye_inclination_input, f) for f in sorted(os.listdir(eye_inclination_input)) if f.lower().endswith((".jpg", ".png", ".jpeg"))]
        self.index = 0
