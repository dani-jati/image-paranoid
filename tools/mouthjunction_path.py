...
"""
if os.path.isdir(cropper_output) and not os.path.exists(mouthjunction_path_input):
    os.symlink(cropper_output, mouthjunction_path_input)
    print(f"🔗 Symlink created: {mouthjunction_path_input} → {cropper_output}")
elif os.path.islink(mouthjunction_path_input):
    print(f"✅ Symlink already exists: {mouthjunction_path_input} → {os.readlink(mouthjunction_path_input)}")
elif os.path.isdir(mouthjunction_path_input):
    print(f"⚠️ Destination exists as a real folder: {mouthjunction_path_input} — not creating symlink.")
else:
